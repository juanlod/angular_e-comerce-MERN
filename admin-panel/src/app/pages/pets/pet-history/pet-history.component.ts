...
import { Pet } from 'src/app/api/models/pet';
import { ClientsService } from 'src/app/api/services/clients.service';
import { NotificationService } from 'src/app/api/services/notification.service';
import { PetsService } from 'src/app/api/services/pets.service';
...
export class PetHistoryComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    // Load master data
    const [petsSex, petsRace, petsSpecies, petsCoat, provinces, localities] = await Promise.all([
